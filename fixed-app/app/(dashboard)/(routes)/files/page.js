    ...
    <div className="p-5 px-8 md:px-16">
      ...
      {loading ? (
        ...
        <div className="text-center mt-20 text-gray-400">
          ...
          <Link
            href="/upload"
            className="mt-4 inline-block bg-amber-400 text-white px-6 py-2 rounded-full text-sm hover:bg-amber-500"
          >
            Upload a File
          </Link>
        </div>
            ...
            <tbody>
              {files.map((file) => (
                <tr key={file.id} className="border-b hover:bg-gray-50 transition">
                  ...
                  <td className="p-3">
                    {file.password ? (
                      <span className="text-green-500 text-xs font-medium">Protected</span>
                    ) : (
